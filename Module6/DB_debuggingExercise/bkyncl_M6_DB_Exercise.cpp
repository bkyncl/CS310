...
* File Name: bkyncl_M6_DB_Exercise.cpp
* Date: 4.18.24
* Description: 
*   This program contains 2 intentional errors for the purpose of debugging practice.
...
int main() {
    ...
    CharacterClass chosen_class = static_cast<CharacterClass>(chosen_class); 
